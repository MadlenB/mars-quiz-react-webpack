...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homePage = __webpack_require__(169);
	
	var _homePage2 = _interopRequireDefault(_homePage);
	
	var _beginPage = __webpack_require__(170);
	
	var _beginPage2 = _interopRequireDefault(_beginPage);
	
	var _testPage = __webpack_require__(171);
	
	var _testPage2 = _interopRequireDefault(_testPage);
	
	var _acceptedPage = __webpack_require__(175);
	
	var _acceptedPage2 = _interopRequireDefault(_acceptedPage);
	
	var _rejectedPage = __webpack_require__(177);
	
	var _rejectedPage2 = _interopRequireDefault(_rejectedPage);
		...
		_createClass(App, [{
			...
			value: function _renderPage() {
				switch (this.state.page) {
					case "home":
						return React.createElement(_homePage2.default, { navigate: this._navigate.bind(this) });
						break;
					case "begin":
						return React.createElement(_beginPage2.default, { navigate: this._navigate.bind(this) });
						break;
					case "test":
						return React.createElement(_testPage2.default, { navigate: this._navigate.bind(this) });
						break;
					case "accepted":
						return React.createElement(_acceptedPage2.default, { navigate: this._navigate.bind(this) });
						break;
					case "rejected":
						return React.createElement(_rejectedPage2.default, { navigate: this._navigate.bind(this) });
				}
			}
		}, {
			key: "render",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BeginPage = function (_React$Component) {
		_inherits(BeginPage, _React$Component);
	
		function BeginPage() {
			_classCallCheck(this, BeginPage);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(BeginPage).apply(this, arguments));
		}
	
		_createClass(BeginPage, [{
			key: "_quiz",
	...
	var TestPage = function (_React$Component) {
		...
		_createClass(TestPage, [{
			...
			value: function _submitAnswer(e) {
				...
				var userAnswer = this.refs.quizInput.value.toLowerCase();
				var hostAnswer = quizList[this.state.question].answer.toLowerCase();
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'p',
								null,
								quizList[this.state.question].question
							),
							React.createElement(
								'form',
								{ className: 'quiz-input' },
								React.createElement('input', { id: 'answer', type: 'text', ref: 'quizInput' }),
								React.createElement(
									'div',
									{ className: 'button-container' },
									React.createElement(
										'button',
										{ id: 'submitButton', type: 'submit', onClick: this._submitAnswer.bind(this) },
										'submit answer'
									)
								)
							)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _retryTimer = __webpack_require__(176);
	
	var _retryTimer2 = _interopRequireDefault(_retryTimer);
	...
	var AcceptedPage = function (_React$Component) {
		_inherits(AcceptedPage, _React$Component);
	
		function AcceptedPage() {
			_classCallCheck(this, AcceptedPage);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(AcceptedPage).apply(this, arguments));
		}
		...
		_createClass(AcceptedPage, [{
			...
			value: function render() {
				return React.createElement(
					'div',
					{ className: 'flex ending' },
					React.createElement(
						'div',
						{ className: 'retry-timer' },
						React.createElement(_retryTimer2.default, { navigate: this.props.navigate })
					),
					React.createElement(
						'h1',
						{ className: 'accepted' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RetryTimer = function (_React$Component) {
		_inherits(RetryTimer, _React$Component);
	
		function RetryTimer(props) {
			_classCallCheck(this, RetryTimer);
	
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RetryTimer).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RejectedPage = function (_React$Component) {
		_inherits(RejectedPage, _React$Component);
	
		function RejectedPage() {
			_classCallCheck(this, RejectedPage);
	
			return _possibleConstructorReturn(this, Object.getPrototypeOf(RejectedPage).apply(this, arguments));
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/**\n * Eric Meyer's Reset CSS v2.0 \n(http://meyerweb.com/\neric/tools/css/reset/)\n * http://cssreset.com\n */\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed,\nfigure, figcaption, footer, header, hgroup,\nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: 100%;\n  font: inherit;\n  vertical-align: baseline; }\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure,\nfooter, header, hgroup, menu, nav, section {\n  display: block; }\n\nbody {\n  line-height: 1; }\n\nol, ul {\n  list-style: none; }\n\nblockquote, q {\n  quotes: none; }\n\nblockquote:before, blockquote:after,\nq:before, q:after {\n  content: '';\n  content: none; }\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0; }\n\n/* Generated by Font Squirrel (https://www.fontsquirrel.com) on May 1, 2016 */\n/* -- Font-Face Start -- */\n@font-face {\n  font-family: 'open_sans';\n  src: url(\"/build/assets/fonts/opensans-bold.eot\");\n  src: url(\"/build/assets/fonts/opensans-bold.eot?#iefix\") format(\"embedded-opentype\"), url(\"/build/assets/fonts/opensans-bold.woff2\") format(\"woff2\"), url(\"/build/assets/fonts/opensans-bold.woff\") format(\"woff\"), url(\"/build/assets/fonts/opensans-bold.ttf\") format(\"truetype\"), url(\"/build/assets/fonts/opensans-bold.svg#open_sansbold\") format(\"svg\");\n  font-weight: bold;\n  font-style: normal; }\n\n@font-face {\n  font-family: 'open_sans';\n  src: url(\"/build/assets/fonts/opensans-bolditalic.eot\");\n  src: url(\"/build/assets/fonts/opensans-bolditalic.eot?#iefix\") format(\"embedded-opentype\"), url(\"/build/assets/fonts/opensans-bolditalic.woff2\") format(\"woff2\"), url(\"/build/assets/fonts/opensans-bolditalic.woff\") format(\"woff\"), url(\"/build/assets/fonts/opensans-bolditalic.ttf\") format(\"truetype\"), url(\"/build/assets/fonts/opensans-bolditalic.svg#open_sansbold_italic\") format(\"svg\");\n  font-weight: bold;\n  font-style: italic; }\n\n@font-face {\n  font-family: 'open_sans';\n  src: url(\"/build/assets/fonts/opensans-light.eot\");\n  src: url(\"/build/assets/fonts/opensans-light.eot?#iefix\") format(\"embedded-opentype\"), url(\"/build/assets/fonts/opensans-light.woff2\") format(\"woff2\"), url(\"/build/assets/fonts/opensans-light.woff\") format(\"woff\"), url(\"/build/assets/fonts/opensans-light.ttf\") format(\"truetype\"), url(\"/build/assets/fonts/opensans-light.svg#open_sanslight\") format(\"svg\");\n  font-weight: lighter;\n  font-style: normal; }\n\n@font-face {\n  font-family: 'open_sans';\n  src: url(\"/build/assets/fonts/opensans-lightitalic.eot\");\n  src: url(\"/build/assets/fonts/opensans-lightitalic.eot?#iefix\") format(\"embedded-opentype\"), url(\"/build/assets/fonts/opensans-lightitalic.woff2\") format(\"woff2\"), url(\"/build/assets/fonts/opensans-lightitalic.woff\") format(\"woff\"), url(\"/build/assets/fonts/opensans-lightitalic.ttf\") format(\"truetype\"), url(\"/build/assets/fonts/opensans-lightitalic.svg#open_sanslight_italic\") format(\"svg\");\n  font-weight: lighter;\n  font-style: italic; }\n\n/* -- Font-Face End -- */\n.body-container {\n  color: black;\n  font-family: \"open_sans\";\n  font-weight: bold;\n  width: 100vw;\n  display: flex; }\n\nh1 {\n  color: #EDF1F2;\n  font-size: 5.1rem;\n  letter-spacing: -10px;\n  text-transform: uppercase; }\n\np {\n  color: #969696;\n  font-family: \"open_sans\";\n  font-size: 28px;\n  font-weight: lighter;\n  padding-bottom: 20px; }\n\nbutton {\n  background-color: #dbdbdb;\n  border-radius: 4px;\n  font-size: 20px;\n  font-weight: 700;\n  letter-spacing: -1px;\n  outline: none;\n  height: 70px;\n  padding: 0 3.7rem;\n  text-transform: uppercase; }\n\nheader {\n  align-self: center;\n  color: #ffffff;\n  display: none;\n  justify-content: center;\n  max-width: 150px;\n  min-width: 150px; }\n  @media (min-width: 640px) {\n    header {\n      display: flex; } }\n  header h1 {\n    left: 22px;\n    position: absolute;\n    top: 100px;\n    transform: translateX(-75px) rotate(270deg); }\n\n.planet {\n  background-image: url(\"/build/assets/images/planet_mars.jpeg\");\n  background-size: cover;\n  height: 98px;\n  letter-spacing: 0.7rem;\n  text-shadow: 0 1px 0 #ccc, 0 2px 0 #c9c9c9, 0 3px 0 #bbb, 0 4px 0 #b9b9b9, 0 5px 0 #aaa, 0 6px 1px rgba(0, 0, 0, 0.1), 0 0 5px rgba(0, 0, 0, 0.1), 0 1px 3px rgba(0, 0, 0, 0.3), 0 3px 5px rgba(0, 0, 0, 0.2), 0 5px 10px rgba(0, 0, 0, 0.25), 0 10px 10px rgba(0, 0, 0, 0.2), 0 20px 20px rgba(0, 0, 0, 0.15);\n  width: 98px; }\n\n.fa-space-shuttle {\n  font-size: 4rem;\n  left: -12px;\n  position: relative;\n  top: 3px; }\n\n.mars-app-container {\n  background-image: url(\"/build/assets/images/mars.jpg\");\n  background-repeat: no-repeat;\n  background-size: cover;\n  display: flex;\n  font-size: 16px;\n  height: 100vh;\n  justify-content: center;\n  flex: 1 0 80%; }\n\n.mars-app {\n  width: 100%;\n  align-self: center; }\n\n.flex {\n  align-self: center;\n  display: flex;\n  justify-content: center; }\n\n.quiz-box-wrapper {\n  width: 88%;\n  text-align: left; }\n\n.quiz-box-container {\n  background-color: white;\n  padding: 40px; }\n\n.clock {\n  animation-duration: 2s;\n  animation-name: slidein;\n  background: #222;\n  border: 3px solid orange;\n  border-radius: 6px;\n  box-shadow: 0 10px 20px rgba(0, 0, 0, 0.3);\n  color: lightgreen;\n  font-size: 80px;\n  position: absolute;\n  right: 30px;\n  text-align: center;\n  text-shadow: 0 0 2px lime, 0 0 8px rgba(0, 255, 0, 0.5), 0 0 10px rgba(0, 255, 0, 0.8);\n  top: 30px;\n  width: 200px; }\n\n.quiz-input {\n  align-items: flex-end;\n  display: flex;\n  height: 105px;\n  flex-wrap: wrap; }\n\ninput {\n  border: none;\n  border-bottom: 1px solid black;\n  font-family: \"open_sans\";\n  font-size: 30px;\n  font-weight: normal;\n  height: 30px;\n  outline: none;\n  width: 100%; }\n\n.button-container {\n  padding: 20px 0;\n  text-align: right;\n  width: 100%; }\n\n.retry-timer {\n  display: none; }\n\n.ending {\n  align-items: center;\n  background-color: #66CC88;\n  height: 100vh;\n  justify-content: center;\n  position: relative;\n  width: 100%; }\n\n.lose {\n  background-color: firebrick; }\n\n.accepted,\n.rejected {\n  animation: pulse 1s 4s 10;\n  opacity: 0; }\n\n.rejected {\n  animation: pulse 1s 0s 10; }\n\n.launch-wrapper {\n  width: 100%;\n  height: 100%;\n  position: absolute;\n  text-align: center;\n  left: 0; }\n\n.launch {\n  animation: launch 6s ease-in;\n  color: #ffffff;\n  opacity: 0; }\n\n@keyframes slidein {\n  from {\n    margin-left: 100%;\n    text-align: left;\n    width: 200px; }\n  25% {\n    margin-left: 25%;\n    width: 280px; }\n  to {\n    margin-left: 0%;\n    padding: 0 0 0 16px;\n    text-align: left;\n    width: 200px; } }\n\n@keyframes pulse {\n  from {\n    opacity: 0; }\n  25% {\n    opacity: 1; }\n  to {\n    opacity: 0; } }\n\n@keyframes launch {\n  from {\n    font-size: 6rem;\n    opacity: 1;\n    top: 110%; }\n  to {\n    opacity: 1;\n    top: -180%;\n    font-size: 48rem; } }\n", ""]);
